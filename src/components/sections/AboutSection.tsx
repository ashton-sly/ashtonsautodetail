        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <AnimateOnScroll>
            <div className="relative">
              <div className="relative rounded-sm overflow-hidden aspect-[4/5] max-w-sm mx-auto lg:mx-0 bg-charcoal-900">
                <Image
                  src="/images/founder.png"
                  alt="Ashton, founder of Ashton's Auto Detail"
                  fill
                  className="object-cover object-top"
                  sizes="(max-width: 768px) 100vw, 384px"
                />
                {/* Gold corner accents */}
                <div className="absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-bronze z-10" />
                <div className="absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-bronze z-10" />
              </div>
            ...
            <div>
              ...
              <div className="space-y-4 text-charcoal-600 leading-relaxed">
                <p>
                  ...
                  <strong className="text-charcoal-800">Ashton&apos;s Auto Detail</strong> because I saw a gap in
              ...
              <div className="mt-8 pt-8 border-t border-charcoal-200">
                ...
                <p className="text-bronze text-sm font-mono tracking-wide mt-1">Founder, Ashton&apos;s Auto Detail</p>
              </div>
            </div>
          </AnimateOnScroll>
        </div>
