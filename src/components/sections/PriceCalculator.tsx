...
export default function PriceCalculator() {
  ...
  // Unique key so the result div remounts (triggering pop-in) each time a new price appears
  const priceKey = price !== null ? `${service}-${vehicle}` : "empty";
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div
          ...
          className={`rounded-sm border overflow-hidden ${
            price
              ? "border-bronze/40 bg-white/5 price-pop"
