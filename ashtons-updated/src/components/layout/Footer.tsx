        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 pb-12 border-b border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <a
                  href="https://www.google.com/maps/place/Ashton%E2%80%99s+Auto+Detailing/@48.7783175,-123.7106779,647m/data=!3m2!1e3!4b1!4m6!3m5!1s0x548f4f005d60611d:0x711c34dbba134d7a!8m2!3d48.778314!4d-123.708103!16s%2Fg%2F11z85r7l7g?entry=ttu"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="hover:text-bronze transition-colors flex items-center gap-2"
                  aria-label="View Ashton's Auto Detail on Google Maps"
                >
                  <span className="text-bronze">🗺️</span>
                  View on Google Maps
                </a>
