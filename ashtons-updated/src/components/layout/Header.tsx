        ...
        <div className="container-custom">
          <div className="flex items-center justify-between h-[72px]">
            ...
            <a
              ...
              className="hidden lg:flex items-center gap-2 text-cream/70 hover:text-bronze transition-colors duration-200 group"
              aria-label="5.0 star rating on Google"
            >
              ...
              <span className="text-xs font-semibold text-cream/80 group-hover:text-bronze">5.0</span>
              <span className="text-cream/30 text-xs font-mono">·</span>
              <span className="text-xs text-cream/50 font-mono group-hover:text-bronze">Google</span>
            </a>
