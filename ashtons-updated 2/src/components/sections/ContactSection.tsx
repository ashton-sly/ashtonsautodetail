  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-charcoal-800 relative overflow-hidden">
      ...
      <div className="container-custom relative z-10">
          ...
          <AnimateOnScroll>
            <div>
              ...
              <p className="text-cream/65 leading-relaxed mb-10">
                Call for a free quote. We serve Duncan and all of Cowichan Valley — same-week appointments often available.
              </p>
          ...
          <AnimateOnScroll delay={150}>
            <div className="flex flex-col gap-6">
              ...
              <div className="bg-bronze rounded-sm p-8 lg:p-10 text-center">
                ...
                <h3 className="font-display text-2xl font-semibold text-white mb-3">Call for a Free Quote</h3>
                <p className="text-white/80 text-sm mb-7 leading-relaxed">
                  Give us a call and we'll get you sorted — same-week appointments often available across the Cowichan Valley.
                </p>
                <a
                  href={SITE_CONFIG.phoneHref}
        ...
        {/* Google Maps Embed */}
        <div className="mt-14">
          <div className="rounded-sm overflow-hidden border border-white/10" style={{ height: "320px" }}>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2817.4752775782094!2d-123.71067792351876!3d48.778317506338105!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x548f4f005d60611d%3A0x711c34dbba134d7a!2sAshton%E2%80%99s%20Auto%20Detailing!5e1!3m2!1sen!2sca!4v1781603451764!5m2!1sen!2sca"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
              ...
              title="Ashton's Auto Detail on Google Maps — Duncan, BC"
            />
          </div>
          <p className="text-cream/30 text-xs text-center mt-3 font-mono tracking-wide">
            SERVING DUNCAN AND THE ENTIRE COWICHAN VALLEY
          </p>
        </div>
      </div>
    </section>
